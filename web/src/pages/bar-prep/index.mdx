...
3. Practice our rule slapdowns via [our flashcards app](/bar-prep/questions).
   This was not recommended by the Fck the Bar book, but it's something we find
   helpful, because we feel that memorizing the rules is the hardest part to bar
   prep. Our flashcards are more of blocks, because each flashcard contains
   multiple topics that are commonly tested together. By memorizing and reciting
   cues as blocks, we have a better chance of "getting points" from the
   examiners.
