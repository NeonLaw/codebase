  ...
  return (
    <RickieLayout>
      ...
      <p>
        ...
        detective in this case, Jesse Priedo (who retired after wrongly accusing 15
        year old Patrick Wayne Harper of a crime that he was later exonerated for)
        testified for the first time ever that a second more fair line-up was shown
        ...
        first unfair photo line-up and Rickie would likely have been acquitted had
        the jury heard this.
        ...
        minutes ago. Simple subtraction of 7:12 pm minus 5 minutes means that the
        ...
        earliest it would have taken a perpetrator to drive from 2612 Glory View
        would have been 7:28-7:30. This new evidence demonstrates Rickie's need for a
        new trial to show the jury the evidence of his actual innocence. The fact
        that the prosecutor misled the jury at trial into believing that the
        perpetrators fled the crime scene at 7:00 (and at the same time corruptly
        withheld a dispatch report that showed the contrary) is significant because
