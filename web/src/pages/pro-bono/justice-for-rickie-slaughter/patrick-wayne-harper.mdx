export const meta = {
  ...
  filename: 'pro-bono/justice-for-rickie-slaughter/patrick-wayne-harper',
  updatedAt: '2020-07-01',
  tags: 'pro-bono,black-lives-matter,criminal-justice',
  description:
    'The story of Patrick Wayne Harper, an innocent man who suffered years of unjust prison time.',
};
...
pulled Lafon from the driver’s seat and then tried to wave cars down to call 911. The exact amount of time this took is uncertain, but the shooting did
