...
file an SS-4 form if the IRS rejects your application online by the IRS with
error code 101, which usually means a similar business has applied for an EIN
before.
