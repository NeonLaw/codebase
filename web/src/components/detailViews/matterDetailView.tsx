    ...
    return (
      <Box>
        ...
        {data.matter.description && (
          <Text>{convertSlateToPlaintext(data.matter.description)}</Text>
        )}
        <Heading as="h3" marginTop={gutters.medium}>
          Documents
        </Heading>
        ...
        <AdminOnly>
          ...
          <CreateMatterContactModal isOpen={isOpen} onClose={onClose} />
          <UpdateMatterModal
